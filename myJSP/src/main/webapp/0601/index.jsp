...
<body>
	...
	<!-- 선언부 -->
	<p>
		JSP파일이 서블릿 파일로 변환시 _jspService()메서드 외부에 작성되어 전역변수, 메서드 생성
	</p>
	<%! 
		//선언부
	...
	<p>
	워크스페이스\.metadata\.plugins\org.eclipse.wst.server.core\tmp0\work\Catalina\localhost\ROOT\org\apache\jsp
	</p>
</body>
</html>